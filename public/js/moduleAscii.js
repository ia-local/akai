/**
 * LIBRAIRIE TENSOR ASCII V2.0 (Format ES6 pour Navigateur)
 * Rôle : Fournir les constantes graphiques et les utilitaires de génération de texte.
 */
...
export const TENSOR_RENDER = {
    ...
    FILL_HEAVY: '▓', 
    FILL_SOLID: '█', 
    // Ajouts pour la densité (Soup Engine)
    DENSITY: " .:-=+*#%@@",
};
...
// =================================================================
// 2. LOGIQUE DE FORMATAGE (PROCESSOR)
// =================================================================
